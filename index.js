...
const pageLoaded = () => {
    ...
    // Lazy load images from local assets
    const imgs = document.querySelectorAll('[data-src]');
    imgs.forEach(img => {
        img.setAttribute('src', './assets' + img.getAttribute('data-src').substring(1));
    });
    ...
    document.getElementById('contact-form').setAttribute('src', 'https://docs.google.com/forms/d/e/1FAIpQLSfWiNwShO6gar4jzoj0nQgCFmsXkTxCbCCw2bg-st2gYQ97mQ/viewform?usp=header');
